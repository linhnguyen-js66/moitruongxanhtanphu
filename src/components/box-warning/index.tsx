...
export default function BoxWarning(props: PropBoxWarning) {
  const {label,color= {text: "rgb(var(--link-600))", border: "rgb(var(--link-200))", bgBox: "rgb(var(--link-50))"}} = props;
  return (
    <div className='px-12 py-8 rounded-radius-l border-weight-m flex flex-row gap-8 items-center' style={{background: color.bgBox, borderColor: color.border}}>
